...
function loadRecords(page = 1) {
    ...
    fetch(`/api/core/ui-testing-records/?limit=${pageSize}&offset=${offset}`, {
        method: 'GET',
        headers: {
        ...
        .then(data => {
            ...
            // and legacy plain array responses []
            let results = [];
            let totalCount = 0;
            ...
            displayPagination(page, Math.ceil((totalCount || 0) / pageSize));
        })
        .catch(error => {
