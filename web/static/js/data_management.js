(function () {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const openModuleScenarioModal = (mode, moduleId, scenario = null) => {
            ...
            // In View mode we hide actions by default; clicking the description can
            // enable TinyMCE + show Save without changing the modal title.
        ...
        try {
            ...
            if (modal && !modal.dataset.scenarioDescClickBound) {
                ...
                modal.addEventListener('click', (ev) => {
                    ...
                    // Show Save button (still keeps header as View Scenario).
                    const submit = modal.querySelector('button[type="submit"]');
