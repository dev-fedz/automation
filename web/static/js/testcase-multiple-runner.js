    ...
    function createModal() {
        ...
        modal.innerHTML += `
                <div class="modal-footer">
                    <button type="button" id="testcase-multi-response-run" class="modal-button">Run Tests</button>
                </div>
            `;
    ...
    try {
        document.addEventListener('click', async function (event) {
            try {
                ...
                // Enrich cases by fetching testcase detail for any case lacking a requestId.
                try {
